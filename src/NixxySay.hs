module NixxySay (nixxySay) where

-- | Have the Haskell logo say something. Got this code from (https://github.com/periodic/haskell-say/blob/master/src/HaskellSay.hs)
nixxySay :: String -> IO ()
nixxySay str = mapM_ putStrLn $ headerLines ++ content ++ nixxyLogoSay
  where
    headerLines = [
      "  " ++ replicate 56 '_',
      " /" ++ replicate 56 ' ' ++ "\\"
